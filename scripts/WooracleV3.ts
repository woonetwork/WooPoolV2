...
let contractName = "WooracleV3ZipInherit";

// const owner = "0x7C8A5d20b22Ce9b369C043A3E0091b5575B732d9";

// NOTE: https://docs.chain.link/data-feeds/price-feeds/addresses?network=polygon&page=1&search=usdt
const tokenToCLOracle: {[key: string]: string} = {
  ...
  "0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359": "0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7", // USDC
  "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174": "0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7", // USDC.e
