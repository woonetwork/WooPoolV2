...
async function main() {
  ...
  const contract = factory.attach("0x88748243DE01c4F3C103F2De2833f39F6807db17");
  ...
  await contract.setWooRouter("0x817Eb46D60762442Da3D931Ff51a30334CA39B74"); // Set WooRouterV2 manually
  await contract.setVaultWeight("0x9BCf8b0B62F220f3900e2dc42dEB85C3f79b405B", 100); // Set vault weight manually
