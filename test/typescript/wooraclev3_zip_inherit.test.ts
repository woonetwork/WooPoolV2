...
import { WooracleV3ZipInherit, WooracleV3, TestChainLink, TestQuoteChainLink } from "../../typechain";
import WooracleV3ZipArtifact from "../../artifacts/contracts/wooracle/WooracleV3ZipInherit.sol/WooracleV3ZipInherit.json";
...
describe("WooracleV3ZipInherit", () => {
    let owner: SignerWithAddress;

    let wethToken: Contract;
    let wooToken: Contract;

    let wooracleV3Zip: WooracleV3ZipInherit;
    ...
    beforeEach(async () => {
        ...
        wooracleV3Zip = (await deployContract(owner, WooracleV3ZipArtifact, [])) as WooracleV3ZipInherit;
