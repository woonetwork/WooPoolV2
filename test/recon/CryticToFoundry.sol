...
contract CryticToFoundry is Test, PoolTargetFunctions, FoundryAsserts {
    ...
    function test_setUp() public {
        ...
        assertTrue(quoteToken.balanceOf(address(this)) != 0, "quoteToken balance is 0");
        assertTrue(baseToken1.balanceOf(address(this)) != 0, "baseToken1 balance is 0");
        assertTrue(baseToken2.balanceOf(address(this)) != 0, "baseToken2 balance is 0");
        ...
        assertTrue(
            maxGamma1 == maxGamma && maxGamma2 == maxGamma && maxGamma2 == maxGamma,
        ...
        assertTrue(reserve1 >= mintAmount, "reserve balance of quoteToken isn't set");
        assertTrue(reserve2 >= mintAmount, "reserve balance of baseToken1 isn't set");
        assertTrue(reserve2 >= mintAmount, "reserve balance of baseToken3 isn't set");
    }
}
